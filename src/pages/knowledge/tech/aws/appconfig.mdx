...
[Link for the client or web app](https://aws-appconfig.vercel.app/) (_the feature flag is on_), **Let me know when you open it, so I can switch the feature off.**
...
The amount of time AWS AppConfig monitors CloudWatch for alerts and rollback if there are any. It could be 10 minutes, a day, or completely skipped.
